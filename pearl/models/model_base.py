...
Model Base
==============
    Abstract base class used to build new modules inside Pearl.
...
from pearl.schedulers import str2scheduler
...
class ModelBase(ptl.LightningModule):
    ...
    class ModelConfig:
        ...
        train_features_path: str = None
        test_features_path: str = None
        val_features_path: str = None
        train_blip_features_path: str = None
        test_blip_features_path: str = None
        val_blip_features_path: str = None
        train_beit3_features_path: str = None
        test_beit3_features_path: str = None
        val_beit3_features_path: str = None
        train_stella_features_path: str = None
        val_stella_features_path: str = None
        test_stella_features_path: str = None
    ...
    def _build_model(self) -> ptl.LightningModule:
        ...
        """
        # Compatibility with previous Pearl versions
        if (
    ...
    def setup(self, stage) -> None:
        ...
        self.train_dataset = SpicaDataset(
            self.train_dataset,
            self.hparams.train_img_dir_path,
            self.hparams.train_features_path,
            self.hparams.train_blip_features_path,
            self.hparams.train_beit3_features_path,
            self.hparams.train_stella_features_path,
        )

        self.val_dataset = SpicaDataset(
            self.val_dataset,
            self.hparams.val_img_dir_path,
            self.hparams.val_features_path,
            self.hparams.val_blip_features_path,
            self.hparams.val_beit3_features_path,
            self.hparams.val_stella_features_path,
        )
        print(
        ...
        if self.hparams.test_path:
            ...
            self.test_dataset = SpicaDataset(
                self.test_dataset, self.hparams.test_img_dir_path,
                self.hparams.test_features_path, self.hparams.test_blip_features_path,
                self.hparams.test_beit3_features_path, self.hparams.test_stella_features_path
            )
...
class SpicaDataset(Dataset):
    def __init__(self, dataset, img_dir_path, features_path, blip_features_path, beit3_features_path, stella_features_path):
    ...
    def __getitem__(self, idx):
        ...
        if self.features_path:
            ...
            for ref_text in ref_texts:
                if ref_text in self.ref_features:
                    ...
                    # print(f"ref_text: {ref_text} not found in ref_features")
        ...
        if self.blip_features_path: 
            ...
            labels["blip_mt_features"] = self.blip_mt_features[mt_text]
            ...
            for ref_text in ref_texts:
                if ref_text in self.blip_ref_features:
                    ...
                    # print(f"ref_text: {ref_text} not found in blip_ref_features")
        ...
        if self.beit3_features_path:
            ...
            labels["beit3_mt_features"] = self.beit3_mt_features[mt_text]
        ...
        if self.stella_features_path:
            labels["stella_mt_features"] = self.stella_mt_features[mt_text]
