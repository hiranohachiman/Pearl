...
from pearl.models.encoders.encoder_base import Encoder
from pearl.tokenizers_ import XLMRTextEncoder
...
if "HOME" in os.environ:
    saving_directory = os.environ["HOME"] + "/.cache/torch/unbabel_pearl/"
else:
