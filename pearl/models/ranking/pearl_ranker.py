...
from pearl.models.ranking.ranking_base import RankingBase
from pearl.models.utils import move_to_cuda
from torchnlp.utils import collate_tensors


class PearlRanker(RankingBase): # extends ptl.LightningModule
    """
    Pearl Ranker class that uses a pretrained encoder to extract features
