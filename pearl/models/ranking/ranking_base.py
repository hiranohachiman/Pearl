...
==============================
    Abstract base class used to build new ranking systems inside Pearl.
...
from pearl.models.utils import average_pooling, max_pooling
from pearl.modules.scalar_mix import ScalarMixWithDropout
from pearl.metrics import WMTKendall
